...
Here is a detailed (and in-progress) example (courtesy Steven Olsen-Smith and William Newmiller's course exercise at the US Air Force Academy) infrastructure of interpretive identifiers in the `<back>` element of Stephen Crane's *Black Riders*.
