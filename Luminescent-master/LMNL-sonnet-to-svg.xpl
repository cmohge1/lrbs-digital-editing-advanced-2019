...
<p:declare-step version="1.0" xmlns:p="http://www.w3.org/ns/xproc"
  xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:lmnl="http://lmnl-markup.net/ns/xproc-extensions"
  ...
  <p:serialization port="process-result" method="xml" indent="true"/>
  ...
  <p:xslt name="LMNL-process" version="2.0">
    <p:input port="stylesheet">
      <p:document href="lib/down/sonnet-static-graph-svg.xsl"/>
    </p:input>
  </p:xslt>
</p:declare-step>
